  ...
  const items = [
    {
      ...
      items: [
        ...
        translations[lang].comparison['thermal-underwear'],
        translations[lang].comparison['сostumes'],
    ...
    },
    {
      ...
      items: [
        ...
        translations[lang].comparison.gloves,
      ],
    ...
    },
    {
      ...
      id: 3,
      items: [
        translations[lang].comparison['ski'],
        translations[lang].comparison['snowboards'],
      ],
      handler: () => setActiveListId(3),
    },
    {
      name: translations[lang].main_menu.hardware,
      id: 4,
      items: [
        translations[lang].comparison.masks,
        translations[lang].comparison.shoes,
        translations[lang].comparison.fasteners,
        translations[lang].comparison.helmets,
        translations[lang].comparison.protection,
        translations[lang].comparison.sticks,
      ],
