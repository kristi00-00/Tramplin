...
import AIILink from '@/components/elements/AIILink/AIILink'
...
const Categories = () => {
  ...
  const images = [
    ...
    { src: img4, id: 4, title: translations[lang].main_page.category_hardware },
  ]
              ...
              <div className={styles.categories__left}>
                <div className={styles.categories__left__top}>
                  ...
                  >
                    ...
                    />
                    <span>
                      {translations[lang].main_page.category_equipment}
                    </span>
                  </Link>
                </div>
                <Link
                ...
                >
                  <Image
                    ...
                    priority
                  />
                  <span>{translations[lang].main_page.category_hardware}</span>
                </Link>
              </div>
            </>
          )}
